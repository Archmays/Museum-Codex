...
`docs/qa/museum-05a/bundle-budget.json` 的 `status=pass`，input hash 为 `sha256:d64995659bb9d8a1331c24ff260ae99a501d4ff0ccad304e6c029e597370cb0a`：

| 门禁 | 实测 | 上限 |
|---|---:|---:|
| Home gzip | 98,684 | 102,942 |
| Home 相对基线增长 | 10.243% | 15% |
| M04 constellation total gzip | 96,319 | 460,800 |
| Gallery initial JSON gzip | 63,263 | 131,072 |
| Artist index total gzip | 81,684 | 460,800 |
| Artist gallery total gzip | 82,160 | 460,800 |
| Artwork detail total gzip | 82,194 | 460,800 |
| Compare total gzip | 84,204 | 460,800 |

Gallery shell 和四个 page chunk 均保持 lazy，不进入 home initial closure；home 对 242 个 derivative locator 的嵌入数为 0。

## 6. Controlled-lab 性能

`docs/qa/museum-05a/performance.json` 绑定最终共享源码树 implementation hash `sha256:db4237f674dcb39ab087ee586622549326a803413037b4bf74b508a221ee43ba`，五个 profile 各三次采样并由独立 validator 重算：

| Profile | First interactive median | LCP median | CLS p95 | Images p95 | Image bytes p95 | Transfer p95 |
|---|---:|---:|---:|---:|---:|---:|
| Desktop artist index | 920.3 ms | 720 ms | 0 | 6 | 83,878 | 271,639 |
| Mobile index / low bandwidth | 1,526.5 ms | 1,520 ms | 0 | 0 | 0 | 187,761 |
| Desktop artwork detail | 933.2 ms | 776 ms | 0 | 1 | 404,230 | 667,583 |
| Mobile artwork detail / Fast 4G | 1,690.4 ms | 1,696 ms | 0 | 1 | 74,246 | 337,599 |
| Mobile compare / low bandwidth | 2,239.2 ms | 1,736 ms | 0 | 0 | 0 | 190,581 |
