...
复核：26 schemas、8 valid/22 expected-invalid governance fixtures、physical release closure、14 valid/28 expected-invalid/4 recorded pipeline fixtures与 142/142 Python tests 通过。
