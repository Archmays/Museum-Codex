...
RELEASE_SPECS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "directory": "public/releases/art-expansion-batch-01-1.5.1",
        "builder_paths": ["scripts/build_museum_09b_ux_release.py", "museum_pipeline/art/ux_release.py"],
        "validator_paths": ["scripts/validate_museum_09b_ux_release.py", "museum_pipeline/art/ux_release.py"],
        "input_paths": [
            "public/releases/art-expansion-batch-01-1.5.0/manifest.json",
    ...
    },
    {
        ...
        "directory": "public/releases/art-expansion-batch-02-1.6.0",
        "builder_paths": ["scripts/run_museum_expansion_batch.py", "museum_pipeline/art/expansion_batch_factory.py"],
        "validator_paths": ["scripts/validate_museum_09c.py", "museum_pipeline/art/expansion_batch_factory.py"],
        "input_paths": [
