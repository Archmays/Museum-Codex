...
export const INTERACTION_ART_RELEASE_ID = "release:art-expansion-batch-01-1.5.1";
export const INTERACTION_ART_RELEASE_VERSION = "1.5.1";
export const PATH_ART_RELEASE_ID = "release:art-expansion-batch-01-1.5.1";
export const PATH_ART_RELEASE_VERSION = "1.5.1";
export const TIME_PLACE_ART_RELEASE_ID = "release:art-expansion-batch-01-1.5.1";
export const TIME_PLACE_ART_RELEASE_VERSION = "1.5.1";
export const CURRENT_ART_RELEASE_ID = "release:art-expansion-batch-01-1.5.1";
export const CURRENT_ART_RELEASE_VERSION = "1.5.1";
export const CURRENT_ART_RELEASE_DIRECTORY = "art-expansion-batch-01-1.5.1";
