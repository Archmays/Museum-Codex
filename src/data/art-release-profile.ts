...
export const INTERACTION_ART_RELEASE_ID = "release:art-expansion-batch-05-1.9.0";
export const INTERACTION_ART_RELEASE_VERSION = "1.9.0";
export const PATH_ART_RELEASE_ID = "release:art-expansion-batch-05-1.9.0";
export const PATH_ART_RELEASE_VERSION = "1.9.0";
export const TIME_PLACE_ART_RELEASE_ID = "release:art-expansion-batch-05-1.9.0";
export const TIME_PLACE_ART_RELEASE_VERSION = "1.9.0";
export const CURRENT_ART_RELEASE_ID = "release:art-expansion-batch-05-1.9.0";
export const CURRENT_ART_RELEASE_VERSION = "1.9.0";
export const CURRENT_ART_RELEASE_DIRECTORY = "art-expansion-batch-05-1.9.0";
